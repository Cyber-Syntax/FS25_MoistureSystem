...
local dataDefinitions = {
    ["WHEAT"] = {
        { lower = 0.00, upper = 0.06, grade = CropValueMap.Grades.D, multiplier = 0.7 },
        { lower = 0.06, upper = 0.08, grade = CropValueMap.Grades.C, multiplier = 0.8 },
        ...
        { lower = 0.15, upper = 0.18, grade = CropValueMap.Grades.C, multiplier = 0.8 },
        { lower = 0.18, upper = 1.00, grade = CropValueMap.Grades.D, multiplier = 0.7 }
    },
    ["BARLEY"] = {
        { lower = 0.00, upper = 0.07, grade = CropValueMap.Grades.D, multiplier = 0.7 },
        { lower = 0.07, upper = 0.09, grade = CropValueMap.Grades.C, multiplier = 0.8 },
        ...
        { lower = 0.17, upper = 0.20, grade = CropValueMap.Grades.C, multiplier = 0.8 },
        { lower = 0.20, upper = 1.00, grade = CropValueMap.Grades.D, multiplier = 0.7 }
    }
}
